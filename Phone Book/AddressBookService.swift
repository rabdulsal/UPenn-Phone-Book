...
protocol AddressBookDelegate {
    ...
    func promptForAddressBookAccess()
...
class AddressBookService {
    ...
    static var addressBookDelegate: AddressBookDelegate?
    
    static func checkAddressBookAuthorizationStatus(completion: @escaping (_ accessGranted: Bool)->Void) {
        ...
        case .notDetermined:
            ...
            self.addressBookDelegate?.promptForAddressBookAccess()
        }
        
    }
    
    static func updateAddressBook(contact: Contact) {
    ...
    static func contactExistsInAddressBook(contact: Contact) -> Bool {
